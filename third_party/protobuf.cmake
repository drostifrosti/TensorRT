...
macro(configure_protobuf VERSION)
    ...
    set(Protobuf_BIN_DIR "${Protobuf_INSTALL_DIR}/${Protobuf_TARGET}/bin")
    find_file (CENTOS_FOUND centos-release PATHS /etc)
    if (CENTOS_FOUND)
        set(Protobuf_LIB_DIR "${Protobuf_INSTALL_DIR}/${Protobuf_TARGET}/lib64")
    else (CENTOS_FOUND)
        set(Protobuf_LIB_DIR "${Protobuf_INSTALL_DIR}/${Protobuf_TARGET}/lib")
    endif (CENTOS_FOUND)
    set(Protobuf_INCLUDE_DIR "${Protobuf_INSTALL_DIR}/${Protobuf_TARGET}/include")
    set(Protobuf_INCLUDE_DIRS "${Protobuf_INSTALL_DIR}/${Protobuf_TARGET}/include")
	set(Protobuf_PROTOC_EXECUTABLE  "${Protobuf_BIN_DIR}/protoc.exe")
	message(STATUS  "Protobuf_PROTOC_EXECUTABLE: ${Protobuf_PROTOC_EXECUTABLE}")
    if (CMAKE_BUILD_TYPE STREQUAL "Debug")
        set(Protobuf_LIBRARY "${Protobuf_LIB_DIR}/libprotobufd.lib")
        set(Protobuf_PROTOC_LIBRARY "${Protobuf_LIB_DIR}/libprotocd.lib")
        set(Protobuf_LITE_LIBRARY "${Protobuf_LIB_DIR}/libprotobuf-lited.lib")
    else()
        set(Protobuf_LIBRARY "${Protobuf_LIB_DIR}/libprotobuf.lib")
        set(Protobuf_PROTOC_LIBRARY "${Protobuf_LIB_DIR}/libprotoc.lib")
        set(Protobuf_LITE_LIBRARY "${Protobuf_LIB_DIR}/libprotobuf-lite.lib")
    endif()
    set(protolibType SHARED)
    ...
    if ((${CMAKE_SYSTEM_NAME} STREQUAL "Linux") AND NOT(${CMAKE_SYSTEM_PROCESSOR} STREQUAL "x86_64"))
        ...
        set(Protobuf_LIB_DIR "${Protobuf_INSTALL_DIR}/${Protobuf_TARGET}_${CMAKE_SYSTEM_PROCESSOR}/lib")
        set(Protobuf_INCLUDE_DIR "${Protobuf_INSTALL_DIR}/${Protobuf_TARGET}/include")
        set(Protobuf_INCLUDE_DIRS "${Protobuf_INSTALL_DIR}/${Protobuf_TARGET}/include")
        if (CMAKE_BUILD_TYPE STREQUAL "Debug")
            set(Protobuf_LIBRARY "${Protobuf_LIB_DIR}/libprotobufd.lib")
        ...
        set(Protobuf_INSTALL_DIR "${Protobuf_INSTALL_DIR}/${Protobuf_TARGET}")
        set(protolibType SHARED)
    endif()
...
function(protobuf_generate_cpp SRCS HDRS)
    ...
    foreach(proto ${PROTOS})
        ...
        add_custom_command(
            ...
            COMMAND set LIBRARY_PATH=${Protobuf_LIB_DIR}
